-- Drop and recreate operations_settings table with proper structure
DROP TABLE IF EXISTS operations_settings CASCADE;
...
CREATE TABLE operations_settings (
  ...
  ingredient_sub_categories JSONB DEFAULT '{}',
...
-- Create policies
CREATE POLICY "View operations settings"
...
CREATE POLICY "Manage operations settings"
...
BEGIN
  INSERT INTO operations_settings (
    ...
    jsonb_build_object(
      'Meat', ARRAY['Fresh', 'Frozen', 'Smoked', 'Cured'],
      'Poultry', ARRAY['Fresh', 'Frozen', 'Processed'],
      'Seafood', ARRAY['Fresh', 'Frozen', 'Shellfish'],
      'Produce', ARRAY['Fresh', 'Frozen', 'Processed'],
      'Dairy', ARRAY['Milk', 'Cheese', 'Cream', 'Eggs'],
      'Dry Goods', ARRAY['Grains', 'Pasta', 'Beans', 'Rice']
    ),
