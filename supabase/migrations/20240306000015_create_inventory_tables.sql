-- Create inventory_counts table with proper relationships
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_inventory_counts_org_id ON inventory_counts(organization_id);
CREATE INDEX IF NOT EXISTS idx_inventory_counts_ingredient_id ON inventory_counts(master_ingredient_id);
