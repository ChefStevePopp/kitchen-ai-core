...
const MyShifts: React.FC = () => {
  const { shifts, error, calendarUrl } = useScheduleStore();
  ...
  if (!calendarUrl) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center">
        ...
        <h3 className="text-lg font-medium text-white mb-2">No Schedule Integration</h3>
        <p className="text-gray-400 text-sm max-w-md">
          Connect your scheduling software in Settings to see your upcoming shifts
        </p>
      </div>
    );
  }
